...
public class MyInterface {
    ...
    public MyInterface(UmlInterface umlInterface, MyUmlInteraction myUmlInteraction) {
    ...
    public void getFathers() {
        ...
        for (UmlGeneralization umlGeneralization : fathersBuffer) {
            MyInterface father = myUmlInteraction.getMyInterface(umlGeneralization.getTarget());
