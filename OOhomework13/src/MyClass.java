...
public class MyClass {
    ...
    public MyClass(UmlClass umlClass, MyUmlInteraction myUmlInteraction) {
    ...
    public Map<String, String> getAssociatedClassList() {
        ...
        id2name4associatedClasses.putAll(myUmlInteraction.getAssociateClasses(umlClass.getId()));
    ...
    public Map<String, String> getInterfaceRealization() {
        ...
        for (UmlInterfaceRealization umlInterfaceRealization : id2interfaceRealization.values()) {
            ...
            MyInterface myInterface = myUmlInteraction.getMyInterface(interfaceId);
    ...
    public MyOperation addOperation(UmlOperation umlOperation) {
        MyOperation myOperation = new MyOperation(umlOperation, myUmlInteraction);
    ...
    private void getFather() {
        if (father == null && umlGeneralization != null) {
            ...
            father = myUmlInteraction.getMyClass(fatherId);
        }
    }
}
